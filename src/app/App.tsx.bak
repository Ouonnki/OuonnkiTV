import { OkiLogo, SearchIcon, SettingIcon, CloseIcon } from '@/shared/components/icons'
...
import { useSearchHistory, useSearch } from '@/shared/hooks'

import { useSettingStore } from '@/shared/store/settingStore'

import { Analytics } from '@vercel/analytics/react'
import { SpeedInsights } from '@vercel/speed-insights/react'
import RecentHistory from '@/shared/components/RecentHistory'
import { isBrowser } from 'react-device-detect'
import { useNavigate } from 'react-router'

import { useVersionStore } from '@/shared/store/versionStore'
const UpdateModal = React.lazy(() => import('@/shared/components/UpdateModal'))
