import { Edit3, CheckSquare, Square, Trash2, X } from 'lucide-react'
...
import { useThemeControl } from '@/shared/components/theme/hooks/useTheme'
      ...
      <AnimatePresence mode="wait">
        {isOpen ? (
          ...
          >
            ...
            >
              已选 <span className="text-primary font-medium">{selectedCount}</span>/{totalCount}
            </motion.span>
