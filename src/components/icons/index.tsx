...
export const NoItemIcon = ({
  ...
  <Inbox size={size} className={`text-muted-foreground ${className ?? ''}`} strokeWidth={1} {...props} />
)
...
export const NoResultIcon = ({
  ...
  <SearchX size={size} className={`text-muted-foreground ${className ?? ''}`} strokeWidth={1} {...props} />
)
